...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        'ink-free': ['"Ink Free"', 'Caveat', 'cursive'],
        'cambria': ['Cambria', 'Cambria Math', 'serif'],
      },
      colors: {
        ...
        pcd: {
          DEFAULT: "hsl(var(--pcd))",
          foreground: "hsl(var(--pcd-foreground))",
        },
        covered: {
        ...
        uncovered: {
          DEFAULT: "hsl(var(--uncovered))",
          foreground: "hsl(var(--uncovered-foreground))",
        },
        linked: {
          DEFAULT: "hsl(var(--linked))",
          foreground: "hsl(var(--linked-foreground))",
        },
        unlinked: {
